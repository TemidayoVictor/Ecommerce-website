                                                            ...
                                                            <div class="row">
                                                                <div class="media">
                                                                    <div class="thumbnail object-cover">
                                                                        <a href="#">
                                                                            <img src="{{ asset ('assets-old/products/apparel4.jpg')}}" alt="" />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="dpt-menu">
                                        <ul class="second-links">
                                            <li class="has-child fashion">
                                                ...
                                                <ul style="background-image: url({{ asset ('assets-old/menu/menu_bg1.jpg')}})">
                                                    <li>
                                                        <a href="">Make Up</a>
                                                        <a href="">Skin Care</a>
                                                        <a href="">Hair Care</a>
                                            ...
                                            <li class="has-child homekit">
                                                ...
                                                <div class="mega" style="background-image: url({{ asset ('assets-old/menu/menu_bg2.jpg')}})">
                                                    <div class="flexcol">
                                                        <div class="row">
